...
Background
    ...
    Mind that not all data are publically available. It is therefore possible that one feature type suggests the presence of another, but that pydov returnes a *null* value. This *null* value indicates the confidentiality of the data. The user should contact the data supplier if the information is required.
